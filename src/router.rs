...
pub fn create_router(db: Arc<DatabaseConnection>) -> Router {
    Router::new()
        ...
        .route("/registry/{plugin_id}/versions", get(handlers::list_versions))
        ...
        .route("/{plugin_id}/uninstall", axum::routing::post(handlers::uninstall_plugin))
        .route("/market/catalog", get(handlers::get_market_catalog))
        .route("/market/install", axum::routing::post(handlers::install_from_market_url))
